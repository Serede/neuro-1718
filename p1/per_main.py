...
def main():
    ...
    network = PerNetwork('PerNetwork', size[_input_], size[_output_], learn_rate=learn)
    print(network)

    network.train(train_data[_input_], train_data[_output_], max_epoch=epoch, threshold=threshold)
